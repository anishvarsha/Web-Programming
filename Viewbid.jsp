...
<div class="small-6 large-2 columns"><p style="text-align: center;">Menu</p>
	...
	<form action="postItem.html" method="post">
		<button class="button link center" type="submit" style="font-size: 15px;padding: 15px;width: 180px">Post a New Item</a><br>
	</button>
	</form>
...
<div class="small-6 large-2 columns row small-up-2 large-up-4" id="firstDiv" style="float: right;width: 80%;display: inline;">
	...
	<div class="row">
		<div class="small-6 large-2 columns column small-up-2 large-up-2">
				...
				<input type="submit" class="button link center" style="font-size: 15px;padding: 15px;width: 180px"> Approve Bid</a>
				</form>
			</div>
	</div>
	<hr>
	...
	<hr>
	<a href="#" class="button center" style="font-size: 15px;padding: 15px; width: 150px;">Previous</a>
	<a href="#" class="button center" style="font-size: 15px;padding: 15px;width: 150px;">Next</a>
