...
<div class="top-bar" style="background: #c1bdba;">
	...
	<div class="top-bar-right" style="background: #c1bdba;">
		<ul class="menu" style="background: #c1bdba;">
			...
			<li><button type="button" class="buttonSearch" style="height:30px; line-height:0.3rem;background-color:rgb(43,155,229);color: white; padding: 10px; " >Search</button></li>
			<li>
...
<div class="small-6 large-2 columns"><p style="text-align: center;">Menu</p>
	<hr>
	<form action="productListingsAfterLogin.html" method="post">
		<button class="button link center" type="submit" style="font-size: 15px;padding: 15px;width: 180px">Posted Items</a><br>
	</button>
	</form>
	<form action="bidPostsAfterLogin.html" method="post">
		<button class="button link center" type="submit" style="font-size: 15px;padding: 15px;width: 180px">Bid Posts</a><br>
	</button>
	</form>

	<form action="purchasedItems.html" method="post">
		<button class="button link center" type="submit" style="font-size: 15px;padding: 15px;width: 180px">Purchased Items</a><br>
	</button>
	</form>
...
String userId= (String)request.getAttribute("userId");
			...
			String caddr=(String)request.getAttribute("caddr");
			...
			%>
<div class= "formInput" style="width: 60%;background-color: ">
	<div id="formName" style=" " class="formInput">
		<form method="post" action="Updateprofileserv" style="text-align: center;">
			<h4>Profile Details</h4>
			<div id="col1" >
					<label>FirstName
						<input type="text" placeholder="John" value= <%=fname%> name="fname" >
					</label>
					<label>LastName
						<input type="text" placeholder="John" value= <%=lname%>  name="lname" >
					</label>
					<label>EmailId
						<input type="text" placeholder="john.doe@gmail.com" value= <%=email%> name="email" >
					</label>
					<label>CompleteAddress
						<input type="text" placeholder="" value= <%=caddr%> name="caddr" >
					</label>
					<label>PhoneNumber
						<input type="text" placeholder="" value= <%=phone%> name="phone" >
					</label>
				</div>
				
				<input type="submit" class="button center" style="font-size: 15px;" value="Save pofile">   
				
		</form>
	</div>
	<hr>
	<div id="loginHistory" class="loginHistory">
		<label>Login History
		<p><%=datetime%></p>
...
<div class="callout secondary" style="margin: auto; position: static;bottom: 0; width: 100%">
	<div class="row">
