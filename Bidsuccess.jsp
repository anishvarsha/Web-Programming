...
<br>
  ...
  <form action="Loginwelcome.jsp" method="post" class="button " style="font-size: 15px;padding: 15px; width: 150px; font-family: Menlo"><input type="hidden" value=<%=userName%> name="userId" /><input type="submit" value="Go Back to Shopping" /></form>
</div>
