...
<div class="small-6 large-2 columns row small-up-2 large-up-4" id="firstDiv" style="float: right;width: 80%;display: inline;">
	...
	<br>
			<ol>
				<form name="description.html" action="Postitemserv" method="post">
					...
					<span>
						...
						<input type="radio" name="dept" class="category" value="cameras" style="padding-left:5em"> 
						Cameras
						<input type="radio" name="dept" class="category" value="laptops"> Laptops &#09;
						<input type="radio" name="dept" class="category" value="tablets"> Tablets &#09;
						<br>
					</span><br>
					<input type="checkbox" name="used"> Used or not?<br>
